...
Future<Map<String, dynamic>> sourceforgeUpdate() async {
  const url = 'https://sourceforge.net/projects/tunelo/files/json';

  final headers = {
    'User-Agent':
        'Mozilla/5.0 (Linux; Android 13; TuneloApp) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.0.0 Mobile Safari/537.36',
    'Accept': 'application/json',
    'Referer': 'https://sourceforge.net/projects/tunelo/',
  };
...
Future<Map<String, dynamic>> githubUpdate() async {
  ...
  try {
    final response = await get(
      Uri.parse(
        'https://api.github.com/repos/Deepak07-sanwal/tunelo/releases/latest',
      ),
    );
    ...
    if (response.statusCode == 200) {
      ...
      return {
        ...
        'newVer': version,
        'download_url':
            "https://sourceforge.net/projects/tunelo/files/latest/download",
      };
    } else {
