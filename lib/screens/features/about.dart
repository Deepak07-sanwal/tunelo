              ...
              children: [
                ...
                if (isAppUpdateAvailable && _showUpdateAvailable) ...[
                  ...
                  GeneralCards(
                    ...
                    downloadUrl:
                        'https://github.com/Deepak07-sanwal/tunelo/releases/latest',
                    onClose: () {
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      final uri = Uri.parse(
                        'https://github.com/Deepak07-sanwal/tunelo',
                      );
                      try {
                        ...
                        if (await canLaunchUrl(uri)) {
                          ...
                          info(
                            'Cannot open link: https://github.com/Deepak07-sanwal/tunelo',
                            Severity.error,
                          );
                        }
                      }
